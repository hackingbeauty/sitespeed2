...
module ApplicationHelper
  ...
  def slowest_sites
    ...
    top_ten_slowest = yslow_grades.inject("<table><thead><th>Rank</th><th>Url</th><th>Yslow</th></thead>") {|table, td| table + "<tr><td class='center'>#{td.url.country_rank}</td><td>#{td.url.url}</td><td class='center'>#{td.o}</td></tr>"}
