...
module ApplicationHelper
  ...
  def fastest_sites
    ...
    yslow_grades = Yslow2.find_by_sql(["SELECT o, url_id FROM yslow2s ORDER BY o desc LIMIT 9"])
  ...
  def slowest_sites
    # yslow_grades = Yslow2.find(:all, :order => 'o ASC', :select => 'DISTINCT url_id', :limit => 9)
    yslow_grades = Yslow2.find_by_sql(["SELECT o, url_id FROM yslow2s ORDER BY o asc LIMIT 9"])
